...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>User Monthly Checkins</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{url('admin-dashboard')}}">Home</a></li>
            <li class="breadcrumb-item active">User Monthly Checkins</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
                    ...
                    <table class="table table-bordered table-striped">
                               <thead>
                                   <tr>
                                      ...
                                      <td>Weight (lbs)</td>
                                      <td>Waist (Inches)</td>
                                      <td>Left Arm (Inches)</td>
                                      <td>Right Arm (Inches)</td>
                                      <td>Left Quad (Inches)</td>
                                      <td>Right Quad (Inches)</td>
                                      <td>Comment</td>
                                      <td>Question</td>
                                      <td>Chat</td>
                                   </tr>
